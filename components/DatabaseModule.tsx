    ...
    const handleCreateTableSchema = async () => {
        ...
        try {
            ...
            const schemaSQL = `
                ...
                CREATE TABLE IF NOT EXISTS public.sales ( id TEXT PRIMARY KEY, "globalId" TEXT, "correlativeId" TEXT, "tenantId" TEXT, "branchId" TEXT, date TEXT, "time" TEXT, "clientId" INTEGER, "clientName" TEXT, "docType" TEXT, total NUMERIC, currency TEXT, "exchangeRate" NUMERIC, items JSONB, "paymentBreakdown" JSONB, "detailedPayments" JSONB, "user" TEXT, "sunatStatus" TEXT, "sunatResponse" TEXT, "sunatHash" TEXT );
                ...
                -- Sales Advanced
                CREATE TABLE IF NOT EXISTS public.quotations ( id TEXT PRIMARY KEY, "globalId" TEXT, "correlativeId" TEXT, "tenantId" TEXT, "branchId" TEXT, date TEXT, "time" TEXT, "clientId" INTEGER, "clientName" TEXT, items JSONB, total NUMERIC );
                CREATE TABLE IF NOT EXISTS public.presales ( id TEXT PRIMARY KEY, "globalId" TEXT, "correlativeId" TEXT, "tenantId" TEXT, "branchId" TEXT, date TEXT, "time" TEXT, "deliveryDate" TEXT, "clientId" INTEGER, "clientName" TEXT, items JSONB, total NUMERIC, status TEXT );
